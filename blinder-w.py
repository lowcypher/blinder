...
def ocultar_arquivo(nome_arquivo):
    try:
        win32api.SetFileAttributes(nome_arquivo, 2)  # 2 é o valor para ocultar o arquivo
        print(f"Arquivo '{nome_arquivo}' ocultado com sucesso.")
    except Exception as e:
        print(f"Erro ao ocultar o arquivo '{nome_arquivo}': {e}")

# Exemplo de uso
nome_arquivo = "filekey.key"
ocultar_arquivo(nome_arquivo)
